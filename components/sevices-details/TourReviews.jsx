...
const TourReviews = ({ serviceDetails }) => {
  return (
    <div className="w-full flex flex-col gap-y-[10px] pt-[10px] text-[15px] text-[#434e59]">
      ...
      {serviceDetails.reviews.length===0 && <p className="text-[20px] text-[#434e59]">There are no Reviews In this service!</p>}
      {serviceDetails.reviews.length>0 && serviceDetails?.reviews.map((review) => {
