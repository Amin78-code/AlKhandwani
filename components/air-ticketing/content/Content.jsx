function Content() {
  return (
    <section className="w-full pb-0 pt-[20px] sm:py-[30px] md:py-[70px] ">
      <div className="flex justify-center items-canter gap-x-[50px] w-full lg:max-w-[1440px]  mx-auto px-[20px]">
        <div className="flex flex-col gap-y-[10px] lg:gap-y-[20px] w-full md:w-[570px ] py-[10px] md:py-[30px] lg:py-[40px] px-0 sm:px-[10px] md:px-[30px] mx-auto lg:px-[30px] text-[#d4a051] ">
          ...
          <p>
            ...
            nisi Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
            do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
            enim ad minim on veniam, quis nostrud exercitation ullamco laboris
            nisi ut aliquip extra one Lorem ipsum dolor sit amet, consectetur
            adipisicing elit, sed do eiusmod commodo consequat awesome dolore
            porem.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
            do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
            enim ad minim on veniam, quis nostrud exercitation ullamco laboris
